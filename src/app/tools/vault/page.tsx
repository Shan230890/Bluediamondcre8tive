      ...
      <>
        <section className="fs-hero" style={{ padding: "56px 24px 32px" }}>
          <div className="fs-hero-inner">
            <Eyebrow>Vault preview</Eyebrow>
            <LineReveal
              as="h1"
              className="bdc-hero-h1"
              lines={["What the Vault looks like", "once you're inside."]}
            ...
            <p className="lead">
              ...
              Vault UI ships with the client dashboard.
            </p>
          </div>
        </section>
        ...
        <section className="section section-bg reveal text-center">
          <LineReveal as="h2" lines={["Want this running for your brand?"]} style={{ fontSize: "clamp(24px, 4vw, 32px)" } as React.CSSProperties} />
          <div className="ctas" style={{ marginTop: 20, display: "flex", justifyContent: "center" }}>
            <Pill href="/tools" variant="dark" trailing="arrow">
              See pricing
            </Pill>
          </div>
        </section>
